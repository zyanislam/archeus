                    ...
                    <div class="contentbox">
                        ...
                        ?>
                                    <div class="ui card postbox">
                                        <div class="content">
                                            <i class='right floated bx bx-star iconbox2' style='color:#343400'>
                                                <?php
                                                echo "<td><a href='teacher_post.php?id={$row['tpost_id']}'>Check</a></td>";
                                                ?>
                                            </i>
                ...
                <div class="contentbox">
                    ...
                    <form action="teacher_newpostprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="ui card newpostbox">
                            ...
                            <input class="inup" type="text" name="post_title" id="post_title"
                                placeholder="Title Of Your Post">

                            <span class="spaceboxv"></span>

                            <textarea class="form-control" placeholder="Describe The Opportunity For The Students"
                                name="newpost" id="newpost" style="height: 80px;"></textarea>
                    ...
                    <ul class="menu-links">
                        <li class="nav-link" id="link_list">
                            <a id="rightitems" href="#">
                                ...
                                <span class="text nav-text" onclick="window.location.href = '';"
                                    id="menuitems2">Bookmark</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-link" id="link_list">
                            <a id="rightitems" href="#">
                                <i class='bx bx-duplicate iconbox' style='color:#fc3f5b'></i>
                                <span class="text nav-text" onclick="window.location.href = '';" id="menuitems2">Student
                                    Thesis Posts</span>
                            </a>
                        </li>
